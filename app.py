...
# To show user dashboard and display details on it
...
# To show user profile and display the details of the users
...
# For a user to search quizzes based on their titles
...
# To add a subject on the admin dashboard to further make chapters and quizzes
...
#To make searches in the admin portal using users, subjects and quizzes as criteria
